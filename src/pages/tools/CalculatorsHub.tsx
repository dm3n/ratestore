...
const categories = [
  { id: "all", name: "All Tools", icon: Globe, count: allTools.length },
  { id: "calculators", name: "Calculators", icon: Calculator, count: allTools.filter(t => t.category === "calculators").length },
  { id: "rates", name: "Rate Comparison", icon: Database, count: allTools.filter(t => t.category === "rates").length },
  { id: "credit-cards", name: "Credit Cards", icon: CreditCard, count: allTools.filter(t => t.category === "credit-cards").length },
  { id: "banking", name: "Banking", icon: Building, count: allTools.filter(t => t.category === "banking").length },
  { id: "insurance", name: "Insurance", icon: Shield, count: allTools.filter(t => t.category === "insurance").length },
  { id: "investing", name: "Investing", icon: TrendingUp, count: allTools.filter(t => t.category === "investing").length }
];
              ...
              <CardContent className="relative z-10">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  {rateTools.map((tool, index) => (
                    <div key={tool.id} className="bg-white/10 backdrop-blur-sm rounded-lg p-4 hover:bg-white/20 transition-colors">
              ...
              <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <select
                    ...
                    className="px-4 py-3 border rounded-lg bg-white min-w-[200px]"
                  >
                    {categories.map(cat => (
                  ...
                  <select
                    ...
                    className="px-4 py-3 border rounded-lg bg-white min-w-[150px]"
                  >
                      ...
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <div className="flex flex-col gap-2">
                          <Badge 
                            variant="outline" 
                            className={`text-xs ${
                              tool.difficulty === 'beginner' ? 'bg-green-50 text-green-700 border-green-200' :
                              tool.difficulty === 'intermediate' ? 'bg-yellow-50 text-yellow-700 border-yellow-200' :
