...
interface CalculatorTool {
  ...
  href: string;
  category: "mortgage" | "planning" | "investment" | "debt";
...
const calculators: CalculatorTool[] = [
  ...
  },
  {
    ...
    description: "Compare current vs new loan terms and savings",
    longDescription: "Determine if refinancing makes financial sense by comparing your current mortgage with new loan options and break-even analysis.",
    icon: RefreshCw,
    href: "/refinance",
    category: "mortgage",
    difficulty: "intermediate",
    popular: true,
    features: ["Break-even analysis", "Cost comparison", "Savings timeline", "Rate scenarios"]
  },
  {
    id: "renewal",
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Comprehensive suite of financial calculators to help you make informed decisions about mortgages, 
              home buying, refinancing, and financial planning.
            </p>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <Badge variant="outline" className="mt-1 bg-orange-100 text-orange-700 border-orange-200">
                              Popular
                            </Badge>
                          </div>
                        </div>
...
export default CalculatorsOverview;
