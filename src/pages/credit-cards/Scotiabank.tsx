  ...
  const scotiaCards = [
    {
      ...
      annualFee: "$99",
      welcomeBonus: "10% cash back for 3 months",
      highlights: ["4% on gas and groceries", "2% on drugstores and recurring bills", "1% on everything else"],
      rating: 4.6,
      featured: true
    },
    {
      ...
      highlights: ["No foreign transaction fees", "Priority Pass lounge access", "Travel insurance"],
      rating: 4.5
    },
    {
      ...
      highlights: ["5 points per $1 at Cineplex", "1 point per $1 elsewhere", "No annual fee"],
      rating: 4.1
    }
  ];
          ...
          <div className="container">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Discover Scotiabank's credit cards featuring cash back, Scene+ rewards, and premium travel benefits.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="bg-red-600 hover:bg-red-700">
                  Compare Scotia Cards
                </Button>
        ...
        <section className="py-16">
          <div className="container">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl font-bold text-center mb-12">Popular Scotiabank Credit Cards</h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {scotiaCards.map((card, index) => (
