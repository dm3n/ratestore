...
const TD = () => {
  const tdCards = [
    ...
    },
    {
      ...
      annualFee: "$120",
      welcomeBonus: "9% cash back for 3 months",
    ...
    },
    {
      ...
      highlights: ["3x points on travel", "No foreign transaction fees", "Travel insurance"],
      rating: 4.4
    }
  ];
          ...
          <div className="container">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
                TD Credit Cards in Canada
              </h1>
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Explore TD's comprehensive credit card lineup featuring Aeroplan rewards, cash back, and travel benefits.
              </p>
        ...
        <section className="py-16">
          <div className="container">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl font-bold text-center mb-12">Popular TD Credit Cards</h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {tdCards.map((card, index) => (
