    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-16">
          {/* Hero Header */}
          <div className="relative py-16 px-6 bg-gradient-to-br from-green-50 via-background to-emerald-50 rounded-3xl mb-12 overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-green-500/10 via-transparent to-emerald-500/10 rounded-3xl" />
            <div className="relative max-w-4xl mx-auto">
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
                Earn More On<br />
                <span className="text-primary">Every Grocery</span>
              </h1>
              
              <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-8 leading-relaxed">
                Transform your essential grocery shopping into valuable rewards. 
                Maximize savings at supermarkets across Canada.
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto mb-8">
                <div className="bg-background/80 backdrop-blur-sm p-4 rounded-2xl shadow-sm">
                  ...
                  <div className="text-sm font-medium text-muted-foreground">Cash Back</div>
                </div>
                <div className="bg-background/80 backdrop-blur-sm p-4 rounded-2xl shadow-sm">
                  <div className="text-2xl md:text-3xl font-bold text-primary">$520</div>
                ...
                <div className="bg-background/80 backdrop-blur-sm p-4 rounded-2xl shadow-sm">
                  <div className="text-2xl md:text-3xl font-bold text-primary">Stack</div>
                  <div className="text-sm font-medium text-muted-foreground">Store Rewards</div>
                </div>
              </div>
