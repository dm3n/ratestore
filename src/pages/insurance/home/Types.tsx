...
import { Home, Shield, Building, Users, Calculator, CheckCircle, ArrowRight, Star, Phone, TrendingUp, Clock, Zap } from "lucide-react";
...
const HomeInsuranceTypes = () => {
  ...
  const regions = [{
    name: "Ontario",
    description: "Comprehensive home coverage with provincial considerations",
    popular: true
  }, {
    name: "Alberta",
    description: "Weather-specific protection for Alberta homes",
    popular: true
  }, {
    name: "British Columbia",
    description: "Earthquake and flood coverage for BC properties",
    popular: true
  }, {
    name: "Quebec",
    description: "Coverage meeting Quebec's unique requirements",
    popular: true
  }];
  ...
  return <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 to-green-50">
      <Header />
          ...
          <div className="container">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                {coverageTypes.map((coverage, index) => <Card key={index} className="group relative overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    {coverage.popular && <div className="absolute top-4 right-4 z-10">
          ...
          <div className="container">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {regions.map((region, index) => <Card key={index} className="border-0 shadow-sm hover:shadow-md transition-shadow group">
                    <CardHeader>
          ...
          <div className="container">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                {whyHomeInsurance.map((item, index) => <Card key={index} className="text-center border-0 shadow-sm hover:shadow-lg transition-all duration-300 group">
